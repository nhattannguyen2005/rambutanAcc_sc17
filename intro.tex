...
We evaluate {\em RambutanAcc} on up to 16 K80 GPUs using three HPC benchmarks: Sparse Cholesky Factorization, Communication-Avoiding Cannon's Matrix Multiplication~\cite{25Dcannon}, and a 3D Stencil algorithm.\samW{needs to be consistent with sec5... missing ML code}
...
\begin{itemize}
% \item A task scheduler that supports well fine-grained parallelism on GPUs without algorithmic change
