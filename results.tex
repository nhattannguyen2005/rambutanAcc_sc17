...
In this scenario, on two GPUs the impact of communication overlap and direct GPUs communication is not significant.
...
With such configuration we expect {\em RambutanAcc} to meet the ideal performance as it does on two GPUs.
