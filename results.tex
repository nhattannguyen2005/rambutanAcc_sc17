...
\label{fig:nWorkers}
\end{subfigure}
\caption{Left: the persistent kernel with 2 workers/GPU improves the performance. For this experiment, the matrix sparsities are low (under 30\%). Right: for matrices with higher degrees of sparsity, increasing the number of workers  may further improve the performance}
