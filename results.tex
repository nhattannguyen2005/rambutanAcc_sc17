...
\caption{Strong scaling study on a single compute node consisting of three K80s (six GPU devices). Problem size $512^3$.\samW{I suggest the x-axis be GPU devices (2,4,6).  It also makes sense for there to be a single device (no communication) data point.}}
