...
However, such architectural designs result in many challenging problems.
...
Experimental evaluations on three benchmarks representing different application motifs show significant performance gains at very modest programming cost.
These promising results can lead to special interests in the HPC community in tuning libraries such as cuSPARSE for co-running routines on GPUs.

\end{abstract}

\begin{IEEEkeywords}
Accelerator, Graphics Processing Units, Fine-grained Scheduling, Communication Hiding, Dataflow Runtime 
\end{IEEEkeywords}
